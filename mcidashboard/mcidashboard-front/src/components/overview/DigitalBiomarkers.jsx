      ...
      {loading ? (
        ...
        <div className="grid-container">
          ...
          <div className="grid-item">
            ...
            <DataDistributionChart xData={xData_mci} yData={yData_mci} threshold={threshold_mci} xUser={metricData?.current_user.biomarker_value} swapColors={true} xUserLabel="John Doe"/>
          </div>
