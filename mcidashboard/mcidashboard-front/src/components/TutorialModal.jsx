  ...
  return (
    <div className="tutorial-modal"
      ...
      <div className="tutorial-modal-h">
        <h2 style={{ marginLeft: 0, marginTop: 0, fontSize: '16px', fontWeight: 'bold', color: '#DAD3FF', fontStyle: 'italic'}}>STEP <span style={{fontSize: 24, fontStyle: 'normal', color: 'white'}}>{currentStep+1}</span>/14</h2>
        <div >
